            ...
            <section class="main-content">
                <div class="header-image">
                    <div class="image-wrapper static">
                        <div>
                            <img src="assets/images/Banners/new/Food-Banner.jpg" alt="Pharmaceutical &amp; Life Science Industry Category Page">
                        </div>
                    </div>
                </div>
				...
				<div class="content">
                    <div class="container">
                        <div class="industry-cat-description">
                            <div class="col-md-6">
                                <p class="bold">Omni offers a wide range of homogenizers to accommodate disruption of many food products of varying sizes and toughness. Food QC labs around the world rely on Omni’s high-quality homogenizers as their first step in food product analysis.</p>
                            </div>
                            <div class="col-md-6">
                                <p>As food products vary greatly in size, density and shape, researchers require a variety of homogenizer technologies to comminute the food products from their native form down to smaller components which are amendable to lab scale analysis.</p>
                            </div>
                        </div>
                        <section class="related-industry-fields">
                            <div class="row">
                                ...
                                <div class="col-md-4 related-industry">
                                    <div class="img-wrapper">
                                        <a href="<?php echo $baseURL ?>industry-gmo.php">
                                            <figure>
                                                <img src="assets/images/industries/ind-cat-images/gmo.jpg" alt="GMO industries category">
                                                <figcaption>
                                                    GMO
                                                </figcaption>
                                            </figure>
                                        </a>
                                        <a href="<?php echo $baseURL ?>industry-gmo.php" class="btn btn-solid btn-wide">DISCOVER</a>
                                    </div>
                                    
                                </div>
                                <div class="col-md-4 related-industry">
                                    <div class="img-wrapper">
                                        <a href="<?php echo $baseURL ?>industry-pesticides.php">
                                            <figure>
                                                <img src="assets/images/industries/ind-cat-images/pesticides.jpg" alt="Pesticides in Food Industries Category">
                                                <figcaption>
                                                    PESTICIDES IN FOOD
                                                </figcaption>
                                            </figure>
                                        </a>
                                        <a href="<?php echo $baseURL ?>industry-pesticides.php" class="btn btn-solid btn-wide">DISCOVER</a>
                                    </div>
                                </div>
                                <div class="col-md-4 related-industry">
                                    <div class="img-wrapper">
                                        <a href="<?php echo $baseURL ?>industry-food-safety-quality.php">
                                            <figure>
                                                <img src="assets/images/industries/ind-cat-images/food-safety-quality.jpg" alt="Food Safety/Quality Industries Category">
                                                <figcaption>
                                                    FOOD SAFETY &AMP; QUALITY
                                                </figcaption>
                                            </figure>
                                        </a>
                                        <a href="<?php echo $baseURL ?>industry-food-safety-quality.php" class="btn btn-solid btn-wide">DISCOVER</a>
                                    </div>
                                </div>
                            </div>
                        </section>
